...
def defence(char_name: str, char_class: str) -> str:
    """Блок удара соперника."""
    if char_class == 'warrior':
        return (f'{char_name} блокировал {10 + randint(5, 10): int} урона')
    if char_class == 'mage':
        return (f'{char_name} блокировал {10 + randint(-2, 2): int} урона')
    if char_class == 'healer':
        return (f'{char_name} блокировал {10 + randint(2, 5): int} урона')
